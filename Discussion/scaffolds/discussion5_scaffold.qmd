...
years2 = seq(from = 1, to = 100, by = 1)

newparms2 = list(r = -0.1, carry_capacity = 500)


results2 = ode(initialrabbits, years, dexppop_play, newparms2)
...
source(here::here("R/diffusion.R"))
...
# graph a single point in space through time
# single column (time)
plot(resfast_fixtime$conc[3, ], ylab = "Conc. at t=3  units all space chunks", xlab = "space")
```
